...
<form action="" method="post" class="form">
    ...
    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="darlene1234">
    <button type="submit" value="register" class="submit">Créer un compte</button>
</form>