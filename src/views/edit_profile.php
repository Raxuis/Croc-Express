...
<div class="container">
    <form action="" method="post" class="form">
        ...
        <input type="text" class="form-control" id="firstname" name="firstname" value="<?= htmlspecialchars($userInfos['firstname']) ?>">
        <label for="lastname">Nom : </label>
        <input type="text" class="form-control" id="lastname" name="lastname" value="<?= htmlspecialchars($userInfos['lastname']) ?>">
